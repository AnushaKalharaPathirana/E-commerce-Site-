...
echo '<table border="0" width="80%" cellpadding="10" align="center">
  <tr>
   ...
   <tr>
	...
	<form id="form1" name="form1" method="post" action="MemSearchPro.php">
  <table width="50%" height="127" border="0" align="center" cellpadding="5" cellspacing="0">
    <tr>
      <td width="36%" height="56" class="style1"><div align="center">Member ID</div></td>
      <td width="28%" bgcolor="#FFFFFF"><div align="center">
        <input name="txtmid" type="text" class="style16" id="txtmid" size="18" maxlength="12" />
      </div></td>
      <td width="10%">
