 ...
 <div class="box content">
  ...
  echo '<br><marquee behavior="alternate"><span class="style6"> ::::::::LOWA</span><span class="style7"> STATE </span></font><span class="style8">UNIVERSITY::::::::</span></marquee></marquee>
   ...
   <div align="right"><table width="93%" border="0" cellpadding="5" cellspacing="0">
     <tr>
   <td width="60%" height="330"><div align="right"><a href="LibrarianSaveForm.php">
        <img src="picture/MembSave.png" width="260" height="260"/></a></div></td>
		
       
       <td width="60%" height="330"><div align="center"><a href="LibrarianSearch.php">
     ...
     <tr>
       <td><div align="center"><a href="LibrarianSaveForm.php">
	   <span class="style4"> SAVE LIBRARIAN INFO </span></div></td>
	   
       <td ><div align="center"><a href="LibrarianSearch.php"><span class="style4">
	   SEARCH LIBRARIAN INFO</span></a></div></td>
