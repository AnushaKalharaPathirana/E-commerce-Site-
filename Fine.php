...
echo '<table border="0" width="80%" cellpadding="10" align="center">
   ...
   <tr>
     <td colspan="2" bgcolor="#660066"><font face="calibri" size="6" color="White"><b>FINE</b></font></td>
   </tr>
   ...
   <tr>
	...
	<form id="form1" name="form1" method="post" action="FinePro.php">
  <table width="50%" height="127" border="0" align="center" cellpadding="5" cellspacing="0">
    <tr>
      <td width="36%" height="56" class="style1"><div align="center">ISSUE ID</div></td>
      <td width="28%" bgcolor="#FFFFFF"><div align="center">
        <input name="txtisuid" type="text" class="style16" id="txtisuid" size="18" maxlength="12" />
      </div></td>
      <td width="10%">
	  <td width="26%" bgcolor="#FFFFFF" aligin="center"> 
      <img src="Picture/Fine.png" width="100" height="101"></tr>
    <tr>
      <td class="style8">&nbsp;</td>
      <td bgcolor="#FFFFFF"><label>
        <div align="center">
          <input name="btnsrc" type="submit" class="style3" id="btnsrc" value="Message" />
        </div>
      </label></td>
      <td>&nbsp;</td>
    </tr>
