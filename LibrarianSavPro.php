...
echo '<br><br><table border="0" width="75%" cellpadding="10" align="center">
   <tr><td>
   <a href="LibrarianSaveForm.php"><div align="left"><img src="picture/signout.png" width="26" height="22"></div></a>
...
<?php
   ...
   if(!$conn){
     ...
     $queSave="INSERT INTO librarian VALUES ('$Lid','$name','$nic','$cs','$con','$email','$rdt')";
