...
echo ' <table border="0" width="75%" cellpadding="10" align="center">
   <tr>
   <td><a href="Librarian.php"><div align="left"><img src="picture/signout.png" width="26" height="22"></div></a>
 ...
 if($conn){
     ...
     if(isset($_GET['id'])){
          ...
          $Lid=$_GET['id'];
		        ...
		        $quedel= "DELETE FROM librarian WHERE Lid = '$Lid'";
		  
		     if(mysqli_query($conn,$quedel) ){
		  
		  echo ' <b> <font size="4" face="microsoft tai Le">Employee ID:'.$Lid.' Sucessfully Deleted!!                 </font></b><br></b>
		          <br>
