...
<div class="box header"></div>
 <div class="box sidebar">
  ...
  <a href= "Login.html"><img src="picture/signout.png" width="27" height="28"></a> </div>
...
.style1 {font-family: "Century Gothic"; font-size:22px;}
...
<table border="0" width="80%" cellpadding="10" align="center">
  <tr>
   ...
   <tr>
   <td colspan="2" bgcolor="#660066"><font face="calibri" size="6" color="White"> <b>SEARCH BOOKS </b>   </font></td>
  </tr>
   <tr>
   ...
   <tr>
	...
	<form id="form1" name="form1" method="post" action="BkSearch.php">
  <table width="60%" height="127" border="0" align="center" cellpadding="5" cellspacing="0">
    <tr>
      <td width="36%" height="56" class="style1"><div align="center">Book Name</div></td>
      <td width="28%" bgcolor="#FFFFFF"><div align="center">';
        <?php 
         $mysli=NEW MySQLi('localhost','root','','library_management');
         $result=$mysli->query("SELECT BkName FROM book");
?>
          <select name="cmbbk" class="style8">
