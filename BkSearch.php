...
echo'<tr>
	...
	echo 'Database Connection Error',mysqli_error($conn);
	  ...
	  $bid=$_POST['cmbbk'];
	  $queSearch="SELECT * FROM book WHERE BkName ='$bid'";
	  ...
	  if(!mysqli_query($conn,$queSearch)){
       ...
       echo '<table cellspacing="0" cellpadding="5" align="center" bordercolor="tomato" border="0"             width=100%>
           ...
           <tr>
           <td><font face="microsoft tai Le" size="4" color="Black"><b>Book ID</b></td></font>
           <th><font face="microsoft tai Le" size="4" color="Black"><b>Category</b></th></font>
           <th><font face="microsoft tai Le" size="4" color="Black"><b>Book Name</b></th></font>
           <td><font face="microsoft tai Le" size="4" color="Black"><b>ISBN</b></td></font>
           <th><font face="microsoft tai Le" size="4" color="Black"><b>Edition</b></th></font>
           <th><font face="microsoft tai Le" size="4" color="Black"><b>Aurthor</b></th></font>
		   <th><font face="microsoft tai Le" size="4" color="Black"><b>Publisher</b></th></font>
		   <th><font face="microsoft tai Le" size="4" color="Black"><b>Available Books</b></th></font>
         ...
         while($rv=mysqli_fetch_assoc($res)){
            ...
            <td><font face="microsoft tai Le" size="3">'. $bid.'</td>
            <td> <font face="microsoft tai Le" size="3">'.$isbn.'</td>
			...
			<td> <div align="center"><font face="microsoft tai Le" size="3">'.$av.'</td>
			
   <td>
   <a href="BkUpdate.php?id='.$bid.'"><img src="Picture/pencil1.png" width="55" height="50"></a>
   </td>
   <td>
   <a href="Delete.php?id='.$bid.'"><img src="Picture/Bin.png" width="45" height="46"></a>
   </td>
		...
		echo'</table>';
				  ...
				  echo '<font size = "4" face="microsoft tai Le" color="Black" ><b> Member ID:'.$name.' not in the database!!</b></font>
				  <br></br>
